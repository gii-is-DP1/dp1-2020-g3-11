...
import springfest.configuration.SecurityConfiguration;
import springfest.model.Entrada;
import springfest.model.TipoUsuario;
import springfest.model.Usuario;
import springfest.service.AuthoritiesService;
import springfest.service.UserService;
import springfest.service.UsuarioService;
import springfest.web.UsuarioController;
...
public class UsuarioControllerTests {
	...
	void testProcessNewUsuarioFormHasErrors() throws Exception {
		mockMvc.perform(post("/usuarios/new").with(csrf())
				.param("firstName", "PacoteElMalote")
